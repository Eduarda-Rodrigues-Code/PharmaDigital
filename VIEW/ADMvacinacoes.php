...
<html lang="pt-BR">
    ...
    <body>
        ...
        <header>
            <h1 class="header-title">Cadastro de Vacinas</h1>
        </header>
        <main>
            <button type="button" class="button green mobile" id="cadastrarMedicamento">Cadastrar Vacinas</button>
            <table class="records">
                <thead>
                ...
                <tbody>
                    ...
                    $medicamentos = $medicamentosDAO->selecionaTdsVacinas();
                    foreach ($medicamentos as $M) {
                        ...
                        <tr>
                            ...
                            <td><?= $status ?></td>
                            <td>
                                <a href="editarVacina.php?idmedicamentos=<?= $idmedicamentos ?>" style="color: blue;text-decoration: none;font-size: 26px;"><i class="fa-sharp fa-solid fa-pencil" title="Editar"></i></a>
                                &nbsp; &nbsp; &nbsp; &nbsp;
                                <a href="../CONTROLLER/medicamentoController.php?opc=excluir&idmedicamentos=<?= $idmedicamentos ?>&vacina=vacina" style="color: red;text-decoration: none;font-size: 26px;"><i class="fa-solid fa-trash" title="Excluir"></i></a>
                                &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <div class="modal" id="modal">
                <div class="modal-content">
                    ...
                    <form class="modal-form" action="../CONTROLLER/medicamentoController.php" method="post">
                        ...
                        <input type="text" class="modal-field" placeholder="Nome da Vacina" name="nomeMedicamento">
                        <input type="text" class="modal-field" placeholder="Quantidade" name="quantidade">
                        <input type="hidden" class="modal-field" name="idtipoMedicamento" value="5">
                        ...
                        <footer class="modal-footer">
                            <a href="ADMvacinacoes.php" style="text-decoration: none;font-size: 26px;"><i class="fa-solid fa-arrow-left" title="Voltar"></i></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
