...
<div class="login-box">
    ...
    <form action="../CONTROLLER/loginController.php" method="post">
        <div class="user-box">
            <input type="text" style="color: black" name="email" required="" placeholder="Seu email">
        </div>
        <div class="user-box" >
            <input type="password" style="color: black" name="senha" required=""placeholder="Sua senha">
            <label></label>
        </div>
        <a>
            <span></span>
        ...
        <a href="cadastro.php" class="signup-button">Cadastrar</a>
    </form>
</div>
...
<style>
    ...
    body {
        ...
        background-image: url(../IMAGENS/pexels-alex-green-5699514.jpg);
    }
