...
<html lang="pt-BR">
    ...
    <body>
        ...
        <main>
            ...
            $localizacao = $localizacaoDAO->selecionaID($idlocalizacao);
            $nomeLocal = $localizacao["nomeLocal"];
            $endereco = $localizacao["endereco"];
            $mapa = $localizacao["mapa"];
            ?>
            <div class="modal-content">
                ...
                <form class="modal-form" action="../CONTROLLER/localizacaoController.php" method="post">
                    <input type="hidden" name="idlocalizacao" value="<?= $idlocalizacao ?>">
                    <input type="hidden" name="opc" value="editar">
                    <input type="text" class="modal-field" placeholder="Nome do Local" name="nomeLocal" value="<?= $nomeLocal ?>">
                    <input type="text" class="modal-field" placeholder="Endereço" name="endereco" value="<?= $endereco ?>">
<!--                    <input type="text" class="modal-field" placeholder="Mapa" name="mapa" value="">-->
                    <footer class="modal-footer">
                        <a href="ADMlocalizacao.php" style="text-decoration: none;font-size: 26px;"><i class="fa-solid fa-arrow-left" title="Voltar"></i></a>
                        &nbsp; &nbsp; &nbsp; &nbsp;
