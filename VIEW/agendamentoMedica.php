...
<html lang="pt-br">
    ...
    <body>
        ...
        <form action="../CONTROLLER/agendamentoController.php" method="post">
            <h2>Formulário de Agendamento de Medicações</h2>
            ...
            <div class="form-group gender">
                ...
                <select name="idmedicamentos">
                    ...
                    $todosTipos = $medicamentosDAO->selecionaTds();
            ...
            <div class="form-group date">
                <label for="date">Quantidade Solicitada</label>
                <input type="number" name="quantidadeSolicitada" required="">
            </div>
