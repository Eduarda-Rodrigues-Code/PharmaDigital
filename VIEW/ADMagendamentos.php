...
<html lang="en">
    <head>
        ...
        <title>Agendamento Administradores</title>
        ...
        <style>
            ...
            *{
            ...
            body{
                height: 100vh;
                background-image: url(enfermeira-medindo-paciente-pressao-sangue\ \(1\).jpg);
            ...
            body{
                ...
                background-color: rgb(81, 94, 145);
            }
    ...
    <body>
        ...
        <section class="section-1 container">
            ...
            <div class="action-title">
                <h2>Agendamento Administradores</h2>
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="name_job">Medicações</div>

                <p> Se deseja conferir se algum medicamento esteja reservado, clique aqui.</p>
                <div class="btns">

                    <a href="ADMFormumedi.html"><button>Verificar</button></a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                ...
                <div class="name_job">Vacinações</div>

                <p>Se deseja conferir que alguma vacina esteja reservada, clique aqui</p>
                <div class="btns">

                    <a href="ADMVagendamentos.html">  <button>Verificar</button></a> 
                </div>
            </div>
        </div>
