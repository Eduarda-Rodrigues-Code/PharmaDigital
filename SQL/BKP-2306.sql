...
--
-- Host: 127.0.0.1
-- Generation Time: 23-Jun-2023 às 20:22
...
(1, 'Amoxicilina 500mg', 500, 1, 1, 1),
(4, 'Dipirona 500 mg', 200, 1, 1, 1),
(5, 'Soro Fisiologico', 1000, 1, 3, 3);
...
--
ALTER TABLE `tipomedicamento`
  MODIFY `idtipoMedicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
